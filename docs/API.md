...
```json
{"evt":"info","id":"A1B2C3D4E5F60708","nickname":"Alice","region":"EU","freq":868.1,"power":14,"channel":0,"version":"1.5.23","groups":[{"groupUid":"B64_16_or_32B","channelId32":12345,"canonicalName":"Team Alpha","groupTag":"B64_8_or_16B","myRole":"admin","keyVersion":7}]}
```

`nickname` — опционально. `channel` — только для EU/UK (0–2). `neighbors` — массив Node ID (hex) видимых соседей. `version` — версия прошивки (например 1.5.23).  
