...
final Map<String, Map<String, String>> _strings = {
  ...
  'show_all_ble': {'en': 'Show all BLE devices', 'ru': 'Показать все BLE устройства'},
  ...
  'about_desc': {'en': 'RiftLink — mesh protocol for Heltec WiFi LoRa 32. E2E encryption, BLE, geolocation, telemetry.', 'ru': 'RiftLink — mesh-протокол для Heltec WiFi LoRa 32. E2E-шифрование, BLE, геолокация, телеметрия.'},
  ...
  'ping': {'en': 'Check link (Ping)', 'ru': 'Проверить связь (Ping)'},
  ...
  'no_messages': {'en': 'Messages will appear here. Send broadcast to the network.', 'ru': 'Сообщения появятся здесь. Отправьте broadcast в сеть.'},
