...
static const StrEntry STRINGS[] = {
  ...
  {"gps_search", "Searching", "\xCF\xEE\xE8\xF1\xEA", "Searching"},
  ...
  /* ru: CP1251 — как остальные строки (UTF-8 ломает Adafruit glcdfont с кириллицей). */
  {"menu_display_flip_line_on", "Flip: Yes",
   "\xCF\xE5\xF0\xE5\xE2\xE5\xF0\xED\xF3\xF2\xFC: \xC4\xE0", "Flip:Y"},
  {"menu_display_flip_line_off", "Flip: No",
   "\xCF\xE5\xF0\xE5\xE2\xE5\xF0\xED\xF3\xF2\xFC: \xCD\xE5\xF2", "Flip:N"},
  {"menu_display_180", "Flip", "\xCF\xE5\xF0\xE5\xE2\xE5\xF0\xED\xF3\xF2\xFC", "Flip"},
  ...
  {"disp_flip_title", "Flip", "\xCF\xE5\xF0\xE5\xE2\xE5\xF0\xED\xF3\xF2\xFC", "Flip"},
