...
<p align="center">
  <img src="https://img.shields.io/badge/version-firmware_1.5.27_|_app_1.5.27-888?style=flat-square" alt="Version" />
...
Текущий релиз прошивки и приложения: **1.5.27** (см. [`firmware/src/version.h`](firmware/src/version.h), [`app/pubspec.yaml`](app/pubspec.yaml), [`CHANGELOG.md`](CHANGELOG.md)). Android APK: [релиз v1.5.27 на GitHub](https://github.com/PcDeaDZ/RiftLink/releases/tag/v1.5.27). Веб-прошивка из браузера: [`docs/flasher/`](docs/flasher/) → [`WEB_FLASH_GITHUB.md`](docs/WEB_FLASH_GITHUB.md). Платы **nRF52840** не прошиваются через этот веб-инструмент; см. [`docs/flasher/NRF52.md`](docs/flasher/NRF52.md) и [`firmware/src/faketec/README.md`](firmware/src/faketec/README.md).
...
| [🔎 MESH_PACKET_DIAG.md](docs/MESH_PACKET_DIAG.md) | Чеклист диагностики mesh (ESP / T114): эфир, парсер, крипта, BLE |
