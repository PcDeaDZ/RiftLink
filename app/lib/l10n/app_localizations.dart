...
final Map<String, Map<String, String>> _strings = {
  ...
  'settings_connection_hint': {'en': 'Current BLE PIN and Wi-Fi AP credentials of the node.', 'ru': 'Текущий BLE PIN и данные точки доступа Wi-Fi на узле.'},
  'ble_pin': {'en': 'BLE PIN', 'ru': 'BLE PIN'},
  'regen_pin': {'en': 'Regenerate PIN', 'ru': 'Обновить PIN'},
  'ap_access_point': {'en': 'AP (access point)', 'ru': 'AP (точка доступа)'},
  'regen_ap_password': {'en': 'Regenerate AP password', 'ru': 'Обновить пароль AP'},
